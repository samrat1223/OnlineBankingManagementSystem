...
public class Transaction {
	...
	public Date getTransac_Date() {
		return Transac_Date;
	}
	public void setTransac_Date(Date transac_Date) {
	...
	public Transaction(int transaction_Id, int amount, Date transac_Date, String sender, String receiver,
